...
export interface ApiCandadateCandadate extends Struct.CollectionTypeSchema {
...
export interface ApiVacancyVacancy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    candadate: Schema.Attribute.Relation<
      'manyToOne',
      'api::candadate.candadate'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::candadate.candadate': ApiCandadateCandadate;
